...
public sealed class Perceived(string extension)
{
    ...
    static void ReadHardcodedPerceivedTypes()
    {
        ...
        AddPerceived(".asm", PerceivedType.Text);
        ...
        AddPerceived(".cc", PerceivedType.Text);
        ...
        AddPerceived(".geojson", PerceivedType.Text);
        AddPerceived(".go", PerceivedType.Text);
        AddPerceived(".h", PerceivedType.Text);
        AddPerceived(".hh", PerceivedType.Text);
        AddPerceived(".hhp", PerceivedType.Text);
        AddPerceived(".hhc", PerceivedType.Text);
        AddPerceived(".hhk", PerceivedType.Text);
        ...
        AddPerceived(".inl", PerceivedType.Text);
        ...
        AddPerceived(".lex", PerceivedType.Text);
        ...
        AddPerceived(".ml", PerceivedType.Text);
        AddPerceived(".mli", PerceivedType.Text);
        ...
        AddPerceived(".perl", PerceivedType.Text);
        AddPerceived(".php", PerceivedType.Text);
        ...
        AddPerceived(".pubxml", PerceivedType.Text);
        ...
        AddPerceived(".resjson", PerceivedType.Text);
        ...
        AddPerceived(".sgml", PerceivedType.Text);
        ...
        AddPerceived(".xml", PerceivedType.Text);
        AddPerceived(".xsd", PerceivedType.Text);
        AddPerceived(".xsl", PerceivedType.Text);
        AddPerceived(".xslt", PerceivedType.Text);
        AddPerceived(".y", PerceivedType.Text);
        AddPerceived(".yy", PerceivedType.Text);
        AddPerceived(".y++", PerceivedType.Text);
        AddPerceived(".ypp", PerceivedType.Text);
